...
public class SentimeterRunner implements Runnable {
	private String command;
	private URL urlConn;
	private Map<String,TopGainerBean> topGainerMap;
	private BufferedWriter bwObj;
	
	public SentimeterRunner(URL httpUrl,Map<String,TopGainerBean> topGainers,BufferedWriter bufferWriter,String s){
...
private void writeVolumeToCSVFile(TopGainerBean bean) {
		try {
			bwObj.write(bean.getCompanyName()+","+bean.getHigh()+","+ bean.getLow()+","
					...
					+bean.getSentimeterRating()+","+bean.getApi()+"\n");
